...
#
# You need to work out if the shark will get to you before you can get to the pontoon. To make it easier... as you do
# the mental calculations in the water you either freeze when you realise you are dead, or swim when you realise you 
# can make it! 
#
# You are given 5 variables;
#
# shark_distance = distance from the shark to the pontoon. The shark will eat you if it reaches you before you escape 
# to the pontoon. 
#
# shark_speed = how fast it can move in metres/second.
#
# pontoon_distance = how far you need to swim to safety in metres.
#
